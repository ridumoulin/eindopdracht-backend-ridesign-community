    ...
    protected SecurityFilterChain filter (HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests( auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/users/addFavorite/{username}/{productId}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/shopping-cart/user/{username}/products/{productId}/add-to-cart").permitAll()
